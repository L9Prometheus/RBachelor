...
Fifth, manual digitisation can introduce transcription errors, although the pattern-based results would require systematic errors to change qualitatively.
...
A frequency- or time-weighted network would allow distinguishing frequent direct links from rare ones.
A temporal extension could compare peak and off-peak snapshots.
Directionality could be incorporated as a robustness check.
Correlated disruption scenarios, such as removing complete routes or simulating corridor-level outages, would better approximate real-world events like bridge closures.
